...
```
portfolio/
├── index.html                     Entry HTML, importmap, root <osami-app>
...
│   ├── app/
│   │   └── app-shell.js           <osami-app> root: routing + theme bootstrap
│   ├── components/
│   │   ├── layout/page-footer.js  pageFooter() template fragment
│   │   └── navigation/app-nav.js  <osami-nav> primary nav + theme picker
│   ├── pages/                     One Lit element per route
│   │   ├── home-page.js           <osami-home> Three.js landing scene
│   │   ├── about-page.js
...
- File naming: kebab-case for files, PascalCase for component classes, `kebab-case` custom-element tag names prefixed `osami-`.
