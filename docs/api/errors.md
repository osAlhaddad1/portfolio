...
| Unknown project slug (e.g., `#/work/xyz`) | `<ilithya-project>` renders a "Project not found." block with a back link. |
...
| CDN unreachable (lit / three)           | The page fails to bootstrap; the user sees an empty `<ilithya-app>`. No fallback. |
